...
export const roads: Road[] = [
  ...
  [Place.Gizeh, Place.Sahara],
  [Place.Gizeh, Place.Timgad],
  ...
  [Place.Tombouctou, RedNode.Tombouctou_West],
  ...
  [BlueNode.Novossibirsk_East, Place.GreatWallOfChina],
  ...
  [Place.GreatWallOfChina, Place.AmurRiver],
  ...
  [Place.BeringStraitCrossing, RedNode.CraterLake_NorthWest],
