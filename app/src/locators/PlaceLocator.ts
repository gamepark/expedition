...
const placeCoordinates: Partial<Record<Node, Omit<Coordinates, 'z'>>> = {
  ...
  [Place.Newfoundland]: {x: 30.7, y: 19.3},
  ...
  [Place.Petra]: {x: 56.5, y: 33.5},
  [Place.Babylone]: {x: 63.2, y: 30.1},
